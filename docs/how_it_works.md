...
It mainly uses [miniflux](https://github.com/miniflux/python-client) as a RSS feed client and [pydantic-ai](https://github.com/pydantic/pydantic-ai) as the AI summarization module.
