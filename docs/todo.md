...
- [pydantic](https://github.com/pydantic/pydantic) models, and [docs](https://pydantic.dev/). Might consider [pydantic-ai](https://github.com/pydantic/pydantic-ai) and [docs](https://pydantic.dev/docs/ai/overview/)
- [miniflux client module](https://github.com/miniflux/python-client), and [docs](https://miniflux.app/)
- [anthropic client module](https://github.com/anthropics/anthropic-sdk-python) and [docs](https://platform.claude.com/docs/en/api/sdks/python)
...
- Any secret as environment variables for miniflux, anthropic and email credentials or any better way to manage secrets in a secure way. Secret are:
  - miniflux url, username and password
  - anthropic api key
